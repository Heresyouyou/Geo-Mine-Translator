...
def translate_pdf(pdf_path, output_dir=None, doc_layout_model=None,
    ...
    set_translate_rate_limiter(1)  # QPS=1 稳态≈6 translate, _GATE=4 控制真正并发  # 稳态并发=1 QPS × 6.3s wall ≈ 6 个 translate, 匹配 _GATE=4  # 关掉 BabelDOC QPS 节流 — 让 LlamaBatchEngine._GATE 全权控制并发
